...
def main():
    ...
    parser.add_argument('--coregmethod', default=1, type=int, choices=(0, 1, 2),
    ...
    if not os.path.exists(post_coreg):
        ...
        cmp_a3, cmp_b3, shift_array, qual_array = fl.coregistration(cmp_a2, cmp_b2, (1 / 50E6), 10, method=args.coregmethod)
        del cmp_a2, cmp_b2
        if args.save:
